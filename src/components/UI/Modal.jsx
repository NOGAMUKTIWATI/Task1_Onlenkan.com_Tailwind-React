...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-[9999] bg-headingColor bg-opacity-40">
      <div className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] tansform -translate-x-1/2 -translate-y-1/2 p-5">
        <div>
          <figure>
